    ...
    <header id="header" class="text-center">
        ...
        echo Nav::widget([
            ...
            'items' => [
                ...
                ['label' => 'Избранное', 'url' => ['/site/favorites'], 'visible' => !Yii::$app->user->isGuest && !Yii::$app->user->identity->is_admin],
                ['label' => 'Сделать заказ',
                    'url' => ['/site/order'],
                    'visible' => Yii::$app->user->isGuest || !Yii::$app->user->identity->is_admin],
                ['label' => 'Чат', 'url' => ['/site/chat'], 'visible' => !Yii::$app->user->isGuest && !Yii::$app->user->identity->is_admin],
                ['label' => 'Заявка', 'url' => ['/site/application'], 'visible' => !Yii::$app->user->isGuest && !Yii::$app->user->identity->is_seller && !Yii::$app->user->identity->is_admin],
